...
:url-ci-status-tests: "{url-ci-status}/faas_fn_build_invoke.yml"
:url-ci-status-hadolint: "{url-ci-status}/hadolint.yml"
:url-ci-status-clj-kondo: "{url-ci-status}clj-kondo.yml"
